...
import { AUTH_BTN_STYLE, AUTH_INPUT_CLS } from '@/lib/auth-styles';
...
export default function ProfileSetup({
    ...
    return (
        <>
            ...
            <p className="mt-2 text-sm text-gray-500">{t('setup.welcome_note')}</p>

            <div className="mt-6 mb-6">
                <AuthRegisterStepper current={2} />
            </div>
