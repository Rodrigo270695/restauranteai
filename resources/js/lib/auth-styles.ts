...
/** Tarjeta glass (login, register, forgot, etc.) */
export const AUTH_CARD_STYLE: React.CSSProperties = {
    background:
        'radial-gradient(ellipse 110% 100% at 60% 30%, rgba(255,163,0,0.12) 0%, rgba(7,53,119,0.08) 45%, rgba(255,255,255,0.96) 100%)',
    backdropFilter: 'blur(24px)',
    WebkitBackdropFilter: 'blur(24px)',
    border: '1px solid rgba(7,53,119,0.14)',
    boxShadow: '0 12px 50px rgba(7,53,119,0.12), 0 1px 0 rgba(255,255,255,0.7) inset',
};
...
export const AUTH_BTN_GHOST: React.CSSProperties = {
    background: 'rgba(7,53,119,0.06)',
    border: '1.5px solid rgba(7,53,119,0.14)',
};
